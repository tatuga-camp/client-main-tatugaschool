...
const BasicInformationSection = ({ school }: { school: School }) => {
    ...
    const updateSchool: UseMutationResult<School, Error, RequestUpdateSchoolService, unknown> = useMutation({
        mutationKey: ["update-school"],
        mutationFn: (input: RequestUpdateSchoolService) => UpdateSchoolService(input),
