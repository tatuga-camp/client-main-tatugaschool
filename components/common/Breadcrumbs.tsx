...
const Breadcrumbs = (props: {
  ...
  return (
    <nav aria-label="breadcrumb" className="max-w-full min-w-0">
      <ol className="flex flex-wrap items-center gap-1 rounded-full border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium shadow-sm sm:px-4">
