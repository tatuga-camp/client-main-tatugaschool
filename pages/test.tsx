...
const mockData = {
  ...
  studentInfo: {
    ...
    imageURL:
      "https://avatars.githubusercontent.com/u/29640973?s=64&u=37f5153de3857b97ec7422b859831ab2bf700868&v=4",
    class: "ม.6/4",
  },
  courseInfo: {
  ...
  recommendations:
    "ข้อเสนอแนะจากสรุปผลทักษะ: กลุ่มอาชีพด้านการบริหารธุรกิจ การเงินและการธนาคาร งานบริหาร บัญชี HR นักวางผังทางการเงิน ผู้จัดการฝ่ายขายงานต่างๆ เจ้าของกิจการ นักวิเคราะห์ทางการตลาด เป็นต้น",
  signatureFields: {
