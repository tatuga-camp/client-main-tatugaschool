...
var ModuleFactory = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var _wgpuTextureCreateView = (texturePtr, descriptor) => {
      ...
      if (descriptor) {
        ...
        if (nextInChainPtr !== 0) {
          ...
          var a =
            WebGPU.ComponentSwizzle[HEAP32[(swizzlePtr + 12) >> 2]] || "a";
          swizzle = `${r}${g}${b}${a}`;
        }
        ...
        desc = {
          ...
          dimension:
            WebGPU.TextureViewDimension[HEAP32[(descriptor + 16) >> 2]],
    ...
    function assignWasmExports(wasmExports) {
      ...
      _addBoundTextureAsImageToStream = Module[
        "_addBoundTextureAsImageToStream"
      ] = wasmExports["Wd"];
